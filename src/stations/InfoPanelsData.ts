...
const INFO_DATA: IInfoData[] = [
  ...
  },
  {
    title: 'Hello WebXR!',
    description:
      'A small compendium of interactions and little experiences introducing and celebrating the final specification of the WebXR API.\n \nMade by the Mozilla Mixed Reality team\nmixedreality.mozilla.org',
    offsety: 0.06
  },
  {
  ...
  },
  {
    title: 'Sound Room',
    description:
      'Showcase of positional audio, very useful on XR experiences.\nTry to find where the sounds come from!.',
    offsety: 0.04
  },
  {
    title: 'Graffiti Wall',
